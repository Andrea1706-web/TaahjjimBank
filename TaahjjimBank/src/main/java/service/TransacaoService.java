...
@Service
public class TransacaoService implements CrudService<TransacaoModel>{
    ...
    public TransacaoService(String bucketName, String body) {
        ...
        TransacaoModel bodyMap;
        try {
            bodyMap = objectMapper.readValue(body, TransacaoModel.class);
    ...
    @Override
    public TransacaoModel criar(TransacaoModel model) {
        return null;
    }
}
